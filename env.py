...
OME_APP_LIST_PATH = os.getenv("OME_APP_LIST_PATH", "OM_E_LM/ome/data/app_list.json")
OME_SYSTEM_HANDLER_DELAY = float(os.getenv("OME_SYSTEM_HANDLER_DELAY", 2.0))
OME_TREE_PATH = os.getenv("OME_TREE_PATH", "OM_E_LM/ome/data/tree/execution_tree.json")
OME_LOGS_DIR = os.getenv("OME_LOGS_DIR", "OM_E_LM/ome/data/logs")
OME_ARCHIVE_DIR = os.getenv("OME_ARCHIVE_DIR", "OM_E_LM/ome/data/archive")
OME_TREE_ARCHIVE_DIR = os.getenv("OME_TREE_ARCHIVE_DIR", "OM_E_LM/ome/data/archive")
OME_SCHEMA_DIR = os.getenv("OME_SCHEMA_DIR", "OM_E_LM/ome/library/structures")
OME_SCREENSHOT_DIR = os.getenv("OME_SCREENSHOT_DIR", "OM_E_LM/ome/data/screenshots")
OME_TEMPLATE_DIR = os.getenv("OME_TEMPLATE_DIR", "OM_E_LM/ome/data/opencvsearchdb/templates")
OME_TEMPLATE_INDEX = os.getenv("OME_TEMPLATE_INDEX", "OM_E_LM/ome/data/opencvsearchdb/index.json")
OME_ACTIONS_DIR = os.getenv("OME_ACTIONS_DIR", "OM_E_LM/ome/library/actions")
...
OME_MENU_MAPS_DIR = os.getenv("OME_MENU_MAPS_DIR", "OM_E_LM/ome/data/menu_maps")
OME_WINDOW_MAPS_DIR = os.getenv("OME_WINDOW_MAPS_DIR", "OM_E_LM/ome/data/window_maps")
...
UI_MENU_EXPORT_DIR = os.getenv("UI_MENU_EXPORT_DIR", "OM_E_Py/ome/data/menus")
UI_MAX_ROWS = int(os.getenv("UI_MAX_ROWS", 20))
UI_MESSAGE_EXPORT_DIR = os.getenv("UI_MESSAGE_EXPORT_DIR", "OM_E_Py/ome/data/messages")
UI_APP_LIST_DIR = os.getenv("UI_APP_LIST_DIR", "OM_E_Py/ome/data/appList")
UI_APP_LIST_PATH = os.getenv("UI_APP_LIST_PATH", "OM_E_Py/ome/data/appList/app_list.json")
UI_APP_TEXTFIELD_DIR = os.getenv("UI_APP_TEXTFIELD_DIR", "OM_E_Py/ome/data/textInputs")
...
UI_NAV_EXPORT_DIR = os.getenv("UI_NAV_EXPORT_DIR", "OM_E_Py/ome/data/navigation")
...
UI_PICKER_EXPORT_DIR = os.getenv("UI_PICKER_EXPORT_DIR", "OM_E_Py/ome/data/pickers")
UI_WIN_LIST_DIR = os.getenv("UI_WIN_LIST_DIR", "OM_E_Py/ome/data/windows")
UI_WINDOW_REF_MAP_CONFIG = os.getenv("UI_WINDOW_REF_MAP_CONFIG", "OM_E_Py/ome/data/windows/appName_config/window_ref_map.jsonl")
UI_TRANSLATOR_EXPORT_DIR = os.getenv("UI_TRANSLATOR_EXPORT_DIR", "OM_E_Py/ome/data/navigation/translator")
UI_ACTIVE_BUNDLE_JSON = os.getenv("UI_ACTIVE_BUNDLE_JSON", "OM_E_Py/ome/data/windows/active_target_Bundle_ID.json")
...
TREE_APP_LIST_PATH = os.getenv("TREE_APP_LIST_PATH", "OM_E_Tree/ome/data/app_list.json")
TREE_APP_LIST_DIR = os.getenv("TREE_APP_LIST_DIR", "OM_E_Tree/ome/data/appList")
TREE_SYSTEM_HANDLER_DELAY = float(os.getenv("TREE_SYSTEM_HANDLER_DELAY", 2.0))
TREE_TREE_PATH = os.getenv("TREE_TREE_PATH", "OM_E_Tree/ome/data/tree/execution_tree.json")
TREE_LOGS_DIR = os.getenv("TREE_LOGS_DIR", "OM_E_Tree/ome/data/logs")
TREE_ARCHIVE_DIR = os.getenv("TREE_ARCHIVE_DIR", "OM_E_Tree/ome/data/archive")
TREE_TREE_ARCHIVE_DIR = os.getenv("TREE_TREE_ARCHIVE_DIR", "OM_E_Tree/ome/data/archive")
TREE_SCHEMA_DIR = os.getenv("TREE_SCHEMA_DIR", "OM_E_Tree/ome/library/structures")
TREE_SCREENSHOT_DIR = os.getenv("TREE_SCREENSHOT_DIR", "OM_E_Tree/ome/data/screenshots")
TREE_TEMPLATE_DIR = os.getenv("TREE_TEMPLATE_DIR", "OM_E_Tree/ome/data/opencvsearchdb/templates")
TREE_TEMPLATE_INDEX = os.getenv("TREE_TEMPLATE_INDEX", "OM_E_Tree/ome/data/opencvsearchdb/index.json")
TREE_ACTIONS_DIR = os.getenv("TREE_ACTIONS_DIR", "OM_E_Tree/ome/library/actions")
...
TREE_MENU_MAPS_DIR = os.getenv("TREE_MENU_MAPS_DIR", "OM_E_Tree/ome/data/menu_maps")
TREE_WINDOW_MAPS_DIR = os.getenv("TREE_WINDOW_MAPS_DIR", "OM_E_Tree/ome/data/window_maps")
