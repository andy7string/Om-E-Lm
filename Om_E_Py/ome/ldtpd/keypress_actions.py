...
from ome.AXKeyCodeConstants import *
from ome.ldtpd.server_exception import LdtpServerException

class KeyCombo:
    """
    Helper class to represent a key combination (modifiers and value).
    """
    def __init__(self):
...
class KeyboardOp:
    """
    Keyboard operation helper class for parsing and handling key events.
    """
    def __init__(self):
