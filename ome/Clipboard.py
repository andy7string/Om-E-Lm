...
class Clipboard(object):
    """
    Class to represent clipboard-related operations for text and other data types on macOS.
    Provides methods to interact with the system pasteboard (clipboard).
    """
    ...
    def paste(cls):
        ...
        Returns: Data (string) retrieved or None if empty. Exceptions from AppKit will be handled by caller.
        """
